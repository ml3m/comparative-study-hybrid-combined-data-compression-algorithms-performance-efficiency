// Package performance provides advanced statistical performance monitoring utilities.
//
// This package provides comprehensive performance monitoring capabilities
// suitable for statistical analysis and research applications where every byte and nanosecond matters.
package performance
...
// DetailedResourceSnapshot represents comprehensive system resource snapshot with advanced statistical precision
...
// PrecisionPerformanceProfile contains advanced statistical performance profile with nanosecond precision
...
// StatisticalMonitor provides advanced statistical performance monitoring with nanosecond precision
...
// NewStatisticalMonitor creates a new statistical performance monitor
func NewStatisticalMonitor(samplingIntervalMs float64) (*StatisticalMonitor, error) {
...
// NewAerospaceGradeMonitor is a compatibility alias for NewStatisticalMonitor
// Deprecated: Use NewStatisticalMonitor instead
func NewAerospaceGradeMonitor(samplingIntervalMs float64) (*StatisticalMonitor, error) {
	return NewStatisticalMonitor(samplingIntervalMs)
}

// GetDetailedSnapshot gets comprehensive system resource snapshot
func (m *StatisticalMonitor) GetDetailedSnapshot() DetailedResourceSnapshot {
...
func (m *StatisticalMonitor) StartMonitoring(ctx context.Context) {
	m.monitorMutex.Lock()
	if m.monitoring {
...
func (m *StatisticalMonitor) StopMonitoring() {
	m.monitorMutex.Lock()
	m.monitoring = false
	m.monitorMutex.Unlock()
}
...
func (m *StatisticalMonitor) ProfileOperation(ctx context.Context, operationName string, dataSizeBytes int64, operation func() error) (*PrecisionPerformanceProfile, error) {
	// Pre-operation setup
