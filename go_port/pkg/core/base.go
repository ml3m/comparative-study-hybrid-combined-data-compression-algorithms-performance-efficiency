// Package core provides the foundational components for aerospace-grade compression framework.
//
// This package defines the core interfaces and structures with mission-critical precision
...
// AerospacePrecisionMetrics contains aerospace-grade precision metrics for mission-critical applications
type AerospacePrecisionMetrics struct {
...
func (m *AerospacePrecisionMetrics) UpdateFormattedTimes() {
...
// CompressionResult represents the result from a compression operation with aerospace-grade metrics
type CompressionResult struct {
	...
	PrecisionMetrics AerospacePrecisionMetrics `json:"precision_metrics"`
}
...
// DecompressionResult represents the result from a decompression operation with aerospace-grade metrics
...
// PerformanceMetrics contains comprehensive performance metrics for aerospace applications
